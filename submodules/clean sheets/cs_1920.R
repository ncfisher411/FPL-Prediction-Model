# Get league matches, clean sheets for 2019/20 season
...
#write.csv(df, file="match lineups/lineups1920.csv", row.names = F)
df <- read.csv("match lineups/lineups1920.csv")
gc()

#df2 <- fb_match_report(ids)
#write.csv(df2, file="game_results/results1920.csv")
df2 <- read.csv("game_results/results1920.csv")
gc()
...
write.csv(df4, file = "outputs/time_and_cs_1920.csv", row.names = F)
write.csv(df5, file="outputs/own_goals_1920.csv", row.names = F)
